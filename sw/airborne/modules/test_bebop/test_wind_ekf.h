...
#ifndef TEST_WIND_EKF_H
#define TEST_WIND_EKF_H
...
extern void wind_ekf_init(void);
extern void wind_ekf_periodic(void);
extern void wind_ekf_event(void);

#endif /* TEST_WIND_EKF_H */